    ...
    <div class="totalContent">
        <form :class="theme.themeBtn && 'night-table'" @submit.prevent="save">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input :class="theme.themeBtn && 'night-input-field'" id="name" v-model="state.employeeObj.name"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input :class="theme.themeBtn && 'night-input-field'" id="street-address"
                        v-model="state.employeeObj.address" type="text" class="form-control"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input :class="theme.themeBtn && 'night-input-field'" v-model="state.employeeObj.mobile" type="tel"
        ...
        <table v-if="!state.loading" class="table" :class="theme.themeBtn ? 'night-table-bg' : 'day-table-bg'">
            ...
            <tbody>
                <tr v-for="(employeeObj, i) in state.result.data" :key="employeeObj.id">
                    ...
                    <td>
                        <button @click="edit(employeeObj)" type="button" class="btn"
                            :class="theme.themeBtn ? 'btn-warning' : 'btn-dark'">edit</button>
                        <button @click="deleteData(employeeObj)" type="button" class="btn btn-danger">delete</button>
                    </td>
                </tr>
            </tbody>
        </table>
        <Bootstrap5Pagination class="page-num" align="center" :data="state.result"
            @pagination-change-page="employeeLoad"></Bootstrap5Pagination>
    </div>
</template>
